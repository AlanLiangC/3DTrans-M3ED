...
from m3ed_pcdet.utils.st_train_toolbox import pi3d_self_training_utils
...
def train_one_epoch_st(model, optimizer, source_reader, target_loader, model_func, lr_scheduler,
    ...
    for cur_it in range(total_it_each_epoch):
        ...
        if cfg.SELF_TRAIN.SRC.USE_DATA:
            ...
            source_batch['batch_mode'] = 'source'
...
def train_model_st(model, optimizer, source_loader, target_loader, model_func, lr_scheduler, optim_cfg,
    ...
    ps_pkl = pi3d_self_training_utils.check_already_exsit_pseudo_label(ps_label_dir, start_epoch)
    ...
    with tqdm.trange(start_epoch, total_epochs, desc='epochs', dynamic_ncols=True,
        ...
        for cur_epoch in tbar:
            ...
            if (cur_epoch in cfg.SELF_TRAIN.UPDATE_PSEUDO_LABEL) or \
                ...
                pi3d_self_training_utils.save_pseudo_label_epoch(
                ...
                if rank == 0:
                    if cfg.SELF_TRAIN.get('UPDATE_PSEUDO_LABEL_W_TRAJ', None):
                        pi3d_self_training_utils.optim_pseudo_label_w_traj(
