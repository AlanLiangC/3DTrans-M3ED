...
from m3ed_pcdet.utils.transform_utils import ego_to_world
from m3ed_pcdet.utils import compatibility_utils as compat_utils
...
def get_tracklets(dataset, ps_dict, configs, cls_id):
    ...
    for frame_id in tqdm(ps_dict.keys(), total=len(ps_dict.keys()), desc='generate_trks'):
        ...
        boxes[:,:3] -= dataset.dataset_cfg.SHIFT_COOR
