...
from m3ed_pcdet.utils.transform_utils import get_rotation_near_weighted_mean
...
def nms(boxes, score, thresh=1e-3):
...
def wbf_myimplementation(matched_boxes, src_weights):
    ...
    # Get final box params in Openm3ed_pcdet format (x,y,z,l,w,h,ry,class,score) - hardcoded class here
    box_centre = wbf_centroid - np.array([l_offset, w_offset, h_offset])
