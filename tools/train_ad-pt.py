...
from m3ed_pcdet.datasets import build_dataloader, build_dataloader_multi_db
from m3ed_pcdet.models import build_network, model_fn_decorator
from m3ed_pcdet.utils import common_utils
from train_utils.optimization import build_optimizer, build_scheduler
from pretrain_utils.ad_pt_utils import train_model
...
def main():
    ...
    logger.info('**********************Using Concat_Dataset Loader**********************')
    source_set, _, merge_loader, merge_sampler = build_dataloader_multi_db(
        dataset_cfg_1=cfg.DATA_CONFIG, dataset_cfg_2=cfg.DATA_CONFIG_SRC_2, 
        class_names_1=cfg.CLASS_NAMES, class_names_2=cfg.DATA_CONFIG_SRC_2.CLASS_NAMES, 
    ...
    total_iters_each_epoch = len(merge_loader) if not args.merge_all_iters_to_one_epoch \
                                        else len(merge_loader) // args.epochs
